...
# Trunk drives the merge check. Detect the remote's default branch instead
# of assuming "main", since plenty of repos still use "master" or something
# else. Best-effort; stale is fine for a first pass.
