...
4. **Transitions over keyframes for anything added rapidly.** For toasts and list items, keyframes restart from zero on interruption; transitions retarget smoothly.
